...
```{r, echo=TRUE, eval=FALSE}
setwd("{PATH}/covid-vaccine-impact-orderly/exploration")
source("gather_simulations.R")
source("deaths_averted_plots.R")
```
...
```{r, echo=TRUE, eval=FALSE}
setwd("{PATH}/covid-vaccine-impact-orderly
...
```{r, echo=TRUE, eval=FALSE}
gather_simulations__time_id <- orderly::orderly_run("gather_simulations_time",
                                           parameters = list(
