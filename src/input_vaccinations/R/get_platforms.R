...
types_to_platforms <- function(vaccine_types){
  ...
  case_when(
    vaccine_types %in% c("Pfizer/BioNTech", "Moderna", "Moderna - Spikevax", "Pfizer BioNTech - Comirnaty", "Moderna - mRNA-1273",
                         "Zydus - ZyCov-D", "Pfizer BioNTech - Comirnaty Bivalent Original/Omicron BA.4/BA.5",
                         "Moderna – Spikevax Bivalent Original/Omicron BA.1", "Pfizer BioNTech - Comirnaty Bivalent Original/Omicron BA.1",
                         "Pfizer BioNTech - Comirnaty Bivalent Original/Omicron BA.4/BA.5", "Moderna – Spikevax Bivalent Original/Omicron - Generic",
                         "Pfizer BioNTech - Comirnaty Bivalent Original/Omicron - Generic",
                         "Moderna – Spikevax Bivalent Original/Omicron  - Generic" ###REALLY DNA
                        ) ~ "mRNA",
