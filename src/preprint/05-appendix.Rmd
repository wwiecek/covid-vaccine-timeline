...
Here, we examine the effect of vaccine demand being 5% or 10% lower. We assume that lower demand leads to slower adoption of vaccines - i.e. with 5% lower demand, it takes 5% longer to reach the same level of vaccination coverage, starting from the first day of the vaccination campaign.
