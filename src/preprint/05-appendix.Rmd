...
Here, we examine the effect of people deciding to adopt vaccination at a slower rate. We consider vaccine uptake being 5% (Table \@ref(tab:deaths-averted-table-d95)) or 10% (Table \@ref(tab:deaths-averted-table-d90)) slower. We implemented a reduced demand-induced slowdown by inserting an additional day with 0 vaccinations every $\\frac{1}{\\text{demand reduction}}$ days.  
