...
differences_table %>%
  kbl(booktabs=TRUE, centering = TRUE, caption = "Total averted deaths under counterfactual scenarios, based on reported deaths. 95\\% intervals are calculated over 100 simulation runs which vary vaccine parameters and duration of natural immunity (see Table S1 in Appendix for details).") %>%
