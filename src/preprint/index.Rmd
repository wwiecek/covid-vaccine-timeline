...
_Fast development of COVID-19 vaccines likely saved millions of deaths. We estimate how many more lives could have been saved if safe and effective vaccines were available earlier in the pandemic. We fit an epidemiological model informed by retrospective data and simulate counterfactual vaccination scenarios for the United Kingdom and the United States where vaccines are available between 30 and 90 days earlier. We find that up to 1 July 2021 reductions are in the range of from 3,600 to 39,000 in the UK and 51,000 to 131,000 in the US, depending on acceleration factor. This corresponds to a maximum of 6 and 4 deaths averted per 10,000 people in the UK and US respectively, or an overall reduction in total deaths of 44% and 30%. We find that our model is sensitive to uncertain vaccine parameters and benefits depend on the time horizon of the analysis. However, the large average reductions we estimate suggests that it is highly cost-effective to make large investments in strategies to expedite vaccine availability._
