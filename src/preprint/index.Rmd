...
vaccinated_plot <- function(sen, quantiles, dates)  {
  ...
  for (last_date_to_display in dates) {
    zoomed_deaths_averted <- deaths_averted_detail %>%
      ...
      group_by(country) %>%
      mutate(
        vac_norm_10 = max(baseline_total_vaccinated_avg_10),
        vac_norm_90 = max(baseline_total_vaccinated_avg_90)
        )

    single_timeseries_plot <- ggplot(zoomed_deaths_averted, aes(x = date)) +
      geom_line(aes(y = (N_avg_10-total_vaccinated_avg_10)/(N_avg_10-baseline_total_vaccinated_avg_10), colour = "10th percentile")) +
      geom_line(aes(y = (N_avg_10-total_vaccinated_avg_90)/(N_avg_10-baseline_total_vaccinated_avg_90), colour = "90th percentile")) +
      geom_ribbon(
        aes(
          ymin = (N_avg_10-total_vaccinated_025_10)/(N_avg_10-baseline_total_vaccinated_avg_10), 
          ymax = (N_avg_10-total_vaccinated_975_10)/(N_avg_10-baseline_total_vaccinated_avg_10)),
        alpha = 0.5,
        fill = colour_10
      ) +
      geom_ribbon(
        aes(ymin = (N_avg_10-total_vaccinated_025_90)/(N_avg_10-baseline_total_vaccinated_avg_90)
          , ymax = (N_avg_10-total_vaccinated_975_90)/(N_avg_10-baseline_total_vaccinated_avg_90)),
        alpha = 0.4,
        fill = colour_90
      ) +
      facet_grid(counterfactual_label ~ country,
      ...
      labs(x = "Date", y = "Unvaccinated in counterfactual/unvaccinated in baseline", color = "Colour")
