...
vaccinated_plot <- function(sen, quantiles, dates)  {
  ...
  for (last_date_to_display in dates) {
    ...
    single_timeseries_plot <- ggplot(zoomed_deaths_averted, aes(x = date)) +
      geom_line(aes(y = vaccinated_perpop_avg_10 - baseline_vaccinated_perpop_avg_10, colour = "10th percentile")) +
      geom_line(aes(y = vaccinated_perpop_avg_90 - baseline_vaccinated_perpop_avg_90, colour = "90th percentile")) +
      geom_ribbon(
        aes(ymin = vaccinated_perpop_025_10-baseline_vaccinated_perpop_avg_10, ymax = vaccinated_perpop_975_10-baseline_vaccinated_perpop_avg_10),
        alpha = 0.5,
        fill = colour_10
      ) +
      geom_ribbon(
        aes(ymin = vaccinated_perpop_025_90-baseline_vaccinated_perpop_avg_90, ymax = vaccinated_perpop_975_90-baseline_vaccinated_perpop_avg_90),
        alpha = 0.4,
        fill = colour_90
      ) +
      facet_grid(counterfactual_label ~ country,
      ...
      labs(x = "Date", y = "Effective number of fully vaccinated baseline/fully vaccinated counterfactual", color = "Colour")
