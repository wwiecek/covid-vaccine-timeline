...
header-includes:
 - \usepackage{natbib}
  ...
  \author[1,2]{Danny Toomey}
  \author[1]{Enlli Lewis}
  \affil[1]{1Day Sooner, Delaware, United States}
  \affil[2]{HHV-6 Foundation, Santa Barbara, California, United States}
