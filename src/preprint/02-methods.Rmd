...
We present details of various sensitivity analyses in [Appendix C - Supplementary Results]. There are many reasons why the model that we use may not adequately capture the impact of making vaccines available earlier. 
